...
func TestValidate(t *testing.T) {
	cases := []struct {
		...
		{"kebab rejects leading hyphen", "-api.md", Kebab,
			"-api.md: filename must be kebab-case"},
		...
		{"exempt basename passes kebab", "CODE_OF_CONDUCT.md", Kebab, ""},
		{"exempt basename passes camel", "CHANGELOG.md", Camel, ""},
		{"exemption applies to nested paths", "docs/README.md", Kebab, ""},
