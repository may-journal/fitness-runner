...
- Outputs a boxed message to stderr (stdout carries the JSON result) with the question, a table of the enabled check names when the runner provides them, and a note about not using `--no-verify`.
